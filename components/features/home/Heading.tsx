...
const Heading = async ({ children, lang }: HeadingProps) => {
  ...
  return (
    <div className="relative w-full">
      ...
      <div className="absolute top-15 inset-0 space-y-7 text-center p-4 sm:p-6 md:p-8 rounded-md">
        <div className="opacity-0 animate-fade-slide-in gap-6 flex flex-col">
