import { getSentParcels } from "@/actions/parcel.actions";
...
const SentPage = async ({
    ...
    const result: ParcelApiResponse = await getSentParcels(page, perPage, tdsCode);
    const TABLE_UNIQUE_ID = "sentParcelsTable"
