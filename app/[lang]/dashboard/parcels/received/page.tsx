import { getReceivedParcels } from "@/actions/parcel.actions";
...
const ReceivedPage = async ({
    ...
    const result: ParcelApiResponse = await getReceivedParcels(page, perPage, tdsCode);
    const TABLE_UNIQUE_ID = "receivedParcelsTable"
    return (
        <ParcelsTableClient
